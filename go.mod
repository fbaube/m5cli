...
require (
	github.com/fbaube/datarepo v0.0.0-20241228082824-469ea5670e0b
	...
	github.com/fbaube/mcfile v0.0.0-20250111190649-ff2045f62dac
...
require (
	...
	github.com/fbaube/orderednodes v0.0.0-20241028093454-a486f48b9a79 // indirect
